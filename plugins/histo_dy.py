...
# channel selection
INSPECT_FEDID = 1114
CHANNEL = {"crate":34, "slot":12, "fiber":22, "fibCh":0}
# shunt information
MAX_SHUNT = 32
SHUNT_EVENT_UNIT = 500 # evt1~500 = shunt 0, evt501~1000 = shunt1, etc..
                ...
                for channelData in block["channelData"].values():  # channel loop
                    ...
                    if channelData["QIE"]:
                        ...
                        if shunt in SELECTED_SHUNT and errf == "ErrF0":
                            ...
                            book.fill((shunt, charge_pedsub), "Charge_vs_GSel_%s_%d_%s" % (errf, fedId, str_ch),
